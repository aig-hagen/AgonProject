...
export const probabilisticArgumentationGlossary: TooltipRegistry = {
  PAF: {
    ...
    content: ['A probabilistic argumentation framework is a tuple $(A, R, P)$ such that $(A, R)$ is an ', { ref: 'AF' }, ' and $P : A \\cup R \\mapsto (0,1]$ is a probability distribution.'],
    reference: LON11,
  },
  ...
  constellations: {
    ...
    content: ['The constellation approach to probabilistic argumentation models uncertainty about the presence of arguments and attacks via a probability distribution over all possible subgraphs of the argumentation framework.'],
    reference: H12,
  },
  ...
  argumentProbability: {
    ...
    content: ['Each argument $a$ in a ', { ref: 'PAF' }, ' is assigned a probability $P(a) \\in [0,1]$ representing the degree of belief in the existence or validity of $a$.'],
  },

  attackProbability: {
    label: 'attack probability',
    title: 'Attack Probability',
    content: ['Each attack $(a, b)$ in a ', { ref: 'PAF' }, ' is assigned a probability $P(a,b) \\in [0,1]$ representing the degree of belief in the attack being present.'],
  },
