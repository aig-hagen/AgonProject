...
const DATABASE_DOCUMENTS_NAME = 'documents'
...
async function setupDb<DocumentT>() {
  const db = await openDB<DocumentsDB<DocumentT>>(
    DATABASE_DOCUMENTS_NAME,
    DATABASE_DOCUMENTS_VERSION,
    {
