...
const { reference, offsetX, placement } = defineProps<{
...
const arrowWidht = 4
const offsetArrowHeadX = -arrowHeadHeight / 2
...
<template>
  <div>
    <div ref="floating" :style="floatingStyles">
      <div
        class="alert alert-info alert-soft ps-6 w-max max-w-xs"
        :style="{
          borderInlineStartWidth: `${arrowWidht}px`,
