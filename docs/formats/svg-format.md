...
Implementation: [`renderGraphSvg.ts`](/src/modules/common/export/renderGraphSvg.ts), [`WindowExport.vue`](/src/modules/common/export/WindowExport.vue), and [`ExportSheet.vue`](/src/modules/common/export/ExportSheet.vue).
